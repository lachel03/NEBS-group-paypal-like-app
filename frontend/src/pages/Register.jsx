...
export default function Register({ switchToLogin }) {
  ...
  const handleSubmit = async () => {
    ...
    else if (!validateMobile(formData.mobileNumber)) newErrors.mobileNumber = 'Invalid mobile number (10–15 digits)';
      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-8 relative z-10">
        ...
        <div className="flex flex-col justify-center text-white space-y-6 p-8">
          ...
          <p className="text-lg text-slate-300 leading-relaxed">
            Create your account and unlock a world of seamless financial transactions. Experience banking reimagined with cutting-edge security and innovation.
          </p>
        ...
        <div className="bg-slate-900 bg-opacity-60 backdrop-blur-xl border border-cyan-500 border-opacity-30 rounded-2xl p-8 shadow-2xl relative">
          ...
          <div className="relative">
            <h1 className="text-3xl font-bold mb-2 text-cyan-400 tracking-wider">Get Started with Palpay</h1>
            <p className="text-cyan-300 text-sm mb-6 opacity-70">Join thousands of users making payments and managing money with confidence.</p>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3 bg-slate-800 bg-opacity-50 border ${errors.fullName ? 'border-red-500' : 'border-cyan-500 border-opacity-30'} rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition`}
                />
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3 bg-slate-800 bg-opacity-50 border ${errors.email ? 'border-red-500' : 'border-cyan-500 border-opacity-30'} rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition`}
                />
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3 bg-slate-800 bg-opacity-50 border ${errors.mobileNumber ? 'border-red-500' : 'border-cyan-500 border-opacity-30'} rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition`}
                />
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3 bg-slate-800 bg-opacity-50 border ${errors.password ? 'border-red-500' : 'border-cyan-500 border-opacity-30'} rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition`}
                />
                <button
                  type="button"
                ...
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {showPassword ? (
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                    )}
                  </svg>
                </button>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3 bg-slate-800 bg-opacity-50 border ${errors.confirmPassword ? 'border-red-500' : 'border-cyan-500 border-opacity-30'} rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition`}
                />
                <button
                  type="button"
